...
Перед любой операцией перечитайте текущие `AGENTS.md`, активные схемы, `REVISION`
и runbook. Опубликованная ветка и установленная ревизия проверяются отдельно;
датированные манифесты описывают только свой выпуск.
