...
- External Codex surface: the CRM Gateway only. The standalone Manager registry
  is internal inventory; production imports only its required
...
- public Gateway and internal Manager manifests match their live schemas;
