...
- Managed fleet and reception printing: follow `/opt/autostop-managed-pc/README.md` and resolve one exact alias.
- FST.KZ: stop here and follow the dedicated access rule in `AGENTS.md`; never reuse home-PC credentials.
